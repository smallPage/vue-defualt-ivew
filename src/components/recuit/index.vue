  ...
  <div>
    <div class="user" style="background:#fff;padding-bottom: 65px;">
      ...
      <p  style="padding:0 20px;height: 88px;border-bottom: 1px solid #ccc;line-height: 88px;font-size: 16px;">
        <span style="color:#2c6fc1;">首页</span> > 招聘
    ...
    <Modal    v-model="newEidtModal.show"
              ...
              style="padding: 20px;">
      <div  slot="header">
        <img src="../../../static/icon/icon_zhaopinshuju_xinjianrenwu.png" alt="">
        <span style="font-size: 24px;color:#333;display: inline-block;vertical-align: top;padding-left: 20px;padding-top: 11px;padding-left: 20px;">招聘</span>
      </div>
