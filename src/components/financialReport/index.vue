  ...
  <div>
    <div class="user" style="background:#fff;padding-bottom: 65px;">
      ...
      <p  style="padding:0 20px;height: 88px;border-bottom: 1px solid #ccc;line-height: 88px;font-size: 16px;">
        <span style="color:#2c6fc1;">首页</span> > 上市公司财报
      ...
      <div style="margin-top: 10px 0px;border: 0;padding: 0px 15px;">
    ...
    <Modal    v-model="newEidtModal.show"
              ...
              style="padding: 20px;">
      <div  slot="header">
        <img src="../../../static/icon/icon_shangshigongsicaibao_xinjianrenwu.png" alt="">
        <span style="font-size: 24px;color:#333;display: inline-block;vertical-align: top;padding-left: 20px;padding-top: 11px;padding-left: 20px;">上市公司财报</span>
      </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        startStop:'../../../static/icon/icon_kaishi.png',
        table: {
          columns: [
            { type: 'selection', width: 70, align: 'center' },
            // { title: '编号', width: 200, key: 'num', sortable: true },
            { title: '任务名称',  key: 'username' },
            { title: '当前数据量',wdth: 80, key: 'nickName' },
            { title: '任务创建时间',wdth: 50, key: 'gmtCreateTime'},
            { title: '状态',width: 140, key: 'refRoleName', render: (h, params) => {
              return h('p', {
                style: {
                  color: params.row.refRoleName == 'DISABLED' ?'#c12c2c': params.row.refRoleName == 'DISABLED'?'#2c6fc1':'#2cc6a4',
                  display: 'inline-block'
                },
              }, params.row.refRoleName);
            } },
            { title: '进度', width: 200, className:'planTab',key: 'gender', align: 'center', render: (h, params) => {
              return h('Progress', {
                attrs:{
                  status:"active",
                  percent:80
...
//            },
            ...
            {
              title: '操作', width: 200, className:'useTab',key: 'actions', align: 'center', render: (h, params) => {
              let _btns = []
              ...
              let _iconStartWrap = h('div', {
                ...
                on: {
                  click: () => {
                    ...
                    this.startStop = '../../../static/icon/icon_zanting.png';
